...
public class TabTemplate  extends AppCompatActivity implements TabHost.OnTabChangeListener,
        ...
        for (int i = 0; i < size; i++) {
            ...
            tab.setContent(new TabHost.TabContentFactory() {
                ...
                public View createTabContent(String tag) {
                    return new View(TabTemplate.this);
                }
            });
            ...
            if (mainTab.equals(MainTab.ME)) {
                ...
                mBvNotice = new BadgeView(TabTemplate.this, cn);
